...
public class ExpeditionTest extends AbstractRemoteTest {
  ...
  public void exploreAndFindResults() throws Exception {
    ...
    assertThat(deadEnds, equalTo(11)); // 12 > 11, merged http://localhost:xxxxxx/rsserv
  ...
  public void listUrlLocations() throws Exception {
    ...
    String[] expectedLocs = new String[] {
      composePath("/hot/duck/soup/resourcelist.xml"),
      composePath("/hot/duck/soup/resourcedump.xml"),
      composePath("/hot/duck/soup/changelist.xml"),
      composePath("/hot/duck/soup/changedump.xml"),
